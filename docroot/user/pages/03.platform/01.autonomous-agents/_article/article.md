...
<div class="flex-block two">
    <div class="img-block">
        <img src="/user/themes/obyte/assets/autonomous-agents/mobile_new.png" alt="">
        <img class="mobile" src="/user/themes/obyte/assets/autonomous-agents/mobile2_new.png" alt="">
    </div>
    <div class="info-block">
